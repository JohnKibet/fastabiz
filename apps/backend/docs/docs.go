    ...
    "paths": {
        ...
        "/products/inventory/price": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Product price update payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/product.UpdateProductInvPriceRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request body or invalid product input",
                        "schema": {
                            "$ref": "#/definitions/handlers.ErrorResponse"
                        }
                    },
        ...
        "/products/inventory/stock": {
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Product stock update payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/product.UpdateProductInvStockRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "payment.Payment": {
            ...
            "properties": {
                ...
                "provider_ref": {
                    "description": "M-Pesa / Stripe refs",
                    "type": "string"
                },
                "status": {
                    "$ref": "#/definitions/payment.PaymentStatus"
        ...
        "product.UpdateProductInvPriceRequest": {
            "type": "object",
            "required": [
                "price",
                "product_id"
        ...
        "product.UpdateProductInvStockRequest": {
            "type": "object",
            "required": [
                "product_id",
                "stock"
